...
1. [X-Engineer - Bisection method for root finding](https://x-engineer.org/bisection-method/)
2. [Timothy Sauer - Numerical Analysis, 3rd Analysis](https://www.pearson.com/en-us/subject-catalog/p/numerical-analysis/P200000006340?view=educator)
